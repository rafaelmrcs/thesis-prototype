...
data_integration.py
────────────────────────────────────────────────────────────────────────────
Integrates the 10,000-point spatial dataset with per-building OSM features.

DESIGN
──────
  Input A : baseline_spatial_clean_2024.csv
              10,000 rows  —  lat | lon | GHI_mean_2024 (kWh/m²/day)
  ...
  Join method : Spatial nearest-neighbour
              Each of the 10,000 random points is matched to the
  ...
  Output : integrated_dataset.csv  —  10,000 rows
