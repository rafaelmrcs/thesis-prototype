            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              {[
                ...
                },
                {
                  ...
                  description: 'Gini-based feature importance from the baseline AdaBoost ensemble. Higher bars indicate features that contributed more splits across all trees in the baseline model.',
                },
                {
